...
{
    public class ShortTermBuyForLongTermVibrationAnalyzer : ISuggestionAnalyzer
    {
        ...
        public ShortTermBuyForLongTermVibrationAnalyzer()
        {
        ...
        public double CalculateForecaseCertainty(IList<TransactionData> orderedTransactions)
        {
            ...
            var last100Trans = orderedTransactions.GetRearPartial(200);
            ...
            MovingAverage avg200of20 = last200Trans.GetMovingAverage(20, t => t.SimpleAvg200);
            MovingAverage avg200of5 = last200Trans.GetMovingAverage(5, t => t.SimpleAvg200);
            MovingAverage avg50of50 = last200Trans.GetMovingAverage(50, t => t.SimpleAvg50);
            MovingAverage avg20of20 = last200Trans.GetMovingAverage(20, t => t.SimpleAvg20);
            MovingAverage avg5of5 = last200Trans.GetMovingAverage(5, t => t.SimpleAvg5);
            MovingAverage close5 = last200Trans.GetMovingAverage(5, t => t.Close);
            ...
            if ((trend200of200 == Trend.TopUp || trend200of200 == Trend.Up || trend200of200 == Trend.Bottom || trend200of200 == Trend.BottomUp || trend200of200 == Trend.BottomDown || trend200of200 == Trend.Vibration || trend200of200 == Trend.VibrationUp || trend200of200 == Trend.VibrationDown) &&
                ...
                (trend5of5 == Trend.Up || trend5of5 == Trend.BottomUp || trend5of5 == Trend.VibrationUp) &&
                (trendClose5 == Trend.Up || trendClose5 == Trend.BottomUp || trendClose5 == Trend.VibrationUp))
            {
