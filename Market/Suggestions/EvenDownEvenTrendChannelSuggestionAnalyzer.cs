...
{
    public class EvenDownEvenTrendChannelSuggestionAnalyzer : TrendChannelSuggestionAnalyzer
    {
        public override string Name { get { return "Even-Down-Even Trend Channel"; } }
