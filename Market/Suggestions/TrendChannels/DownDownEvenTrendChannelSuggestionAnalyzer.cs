...
{
    public class DownDownEvenTrendChannelSuggestionAnalyzer : TrendChannelSuggestionAnalyzer
    {
        public override string Name { get { return "Down-Down-Even Trend Channel"; } }
